...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 02, 2025 at 10:15 AM
...
--
-- Table structure for table `chapter_views`
--
...
ALTER TABLE `book_genres`
  ...
  ADD KEY `book_genres_ibfk_1` (`book_id`);
...
--
-- Indexes for table `chapter_views`
--
...
--
-- AUTO_INCREMENT for table `chapter_views`
--
ALTER TABLE `chapter_views`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `chapter_views`
--
ALTER TABLE `chapter_views`
  ADD CONSTRAINT `chapter_views_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `chapter_views_ibfk_2` FOREIGN KEY (`chapter_id`) REFERENCES `chapters` (`id`);
COMMIT;
